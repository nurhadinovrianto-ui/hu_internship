...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('student_requirements', function (Blueprint $table) {
            ...
            $table->foreignId('payment_verified_by')->nullable()->constrained('users')->nullOnDelete(); // Finance officer
            ...
            $table->foreignId('sks_verified_by')->nullable()->constrained('users')->nullOnDelete(); // BAAK officer
