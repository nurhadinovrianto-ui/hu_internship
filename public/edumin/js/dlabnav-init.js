...
(function($) {
	...
	var primary = getCookie('primary') || "color_1";
	var sidebarBg = getCookie('sidebarBg') || "color_1";
	var sidebarStyle = getCookie('sidebarStyle') || "full";
	...
	console.log(dlabSettingsOptions);
	...
	if (jQuery(".dlab-theme-mode").length > 0) {
		...
		// Apply saved version from cookie
