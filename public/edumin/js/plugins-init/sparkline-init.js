	...
	var sparkLine8 = function(){
		if(jQuery('#sparkline8').length > 0 ){	
			$("#sparkline8").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
				...
				height: "50",
				lineColor: "#800000",
				fillColor: "rgba(110, 115, 247, .5)",
				minSpotColor: "#800000",
				maxSpotColor: "#800000",
				highlightLineColor: "#800000",
				highlightSpotColor: "#800000",
		...
		if(jQuery('#StackedBarChart').length > 0 ){	
			$('#StackedBarChart').sparkline([
				...
				[4, 1, 2]
					...
					barWidth: 10,
					barSpacing: 7, 
					stackedBarColor: ['#0E8A74', '#FB3E7A', '#ff5c00']
				});
		}
	}
	...
	var sparkLine11 = function(){
		if(jQuery('#sparkline11').length > 0 ){
			...
			$("#sparkline11").sparkline([24, 61, 51], {
				...
				height: "100px",
				resize: !0,
				sliceColors: ["rgba(192, 10, 39, .5)", "rgba(0, 0, 128, .5)", "rgba(14, 138, 116, .5)"]
			});
		}	
	}	
