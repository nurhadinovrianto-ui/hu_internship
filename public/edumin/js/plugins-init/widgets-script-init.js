 ...
 var dzChartlist = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(110, 115, 247, 1)',
							borderWidth: "0",
							backgroundColor: 'rgba(110, 115, 247, 1)'
	...
	var chartWidget2 = function(){
		...
		if(jQuery('#chart_widget_2').length > 0 ){
			...
			chart_widget_2gradientStroke.addColorStop(0, "#6e73f7");
			chart_widget_2gradientStroke.addColorStop(1, "#999cf9");
	...
	var chartWidget11 = function(){
		...
		new Chart(chart_widget_11, {
			...
			data: {
				...
				datasets: [{
					label: "Sales Stats",
					backgroundColor: "rgba(251, 62, 122, .5)",
					borderColor: '#FB3E7A',
					...
					datasets: [
						{
							...
							fill:true,
							tension:0.5,
							pointBackgroundColor: 'rgba(110, 115, 247, 1)', 
							pointRadius: 0
						}
					]
				},
