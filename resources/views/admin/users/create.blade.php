...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            ...
            <p class="mb-0">Buat akun pengguna baru dengan menetapkan peran dan mengisi profil khusus perannya.</p>
        </div>
    </div>
                ...
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Contoh: John Doe" value="{{ old('name') }}" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-dark font-weight-bold" for="email">Alamat Email <span class="text-danger">*</span></label>
                            <input type="email" name="email" id="email" class="form-control" placeholder="johndoe@horizon.ac.id" value="{{ old('email') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-dark font-weight-bold" for="password">Kata Sandi <span class="text-danger">*</span></label>
                            <input type="password" name="password" id="password" class="form-control" placeholder="Minimal 8 karakter" required>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label class="form-label text-dark font-weight-bold" for="password_confirmation">Konfirmasi Kata Sandi <span class="text-danger">*</span></label>
                    ...
                    <div id="section-mahasiswa" class="role-section d-none border-top pt-4 mt-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nim" id="nim" class="form-control" placeholder="Contoh: 2021100001" value="{{ old('nim') }}" data-required="true">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="study_program_id" id="mhs_study_program_id" class="form-control" data-required="true">
                                    ...
                                    @foreach($studyPrograms as $sp)
                                        <option value="{{ $sp->id }}" {{ old('study_program_id') == $sp->id ? 'selected' : '' }}>{{ $sp->degree }} - {{ $sp->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="batch" id="batch" class="form-control" placeholder="Contoh: 2021" value="{{ old('batch', now()->year) }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="current_semester" id="current_semester" class="form-control" placeholder="Contoh: 7" value="{{ old('current_semester', 1) }}" min="1" data-required="true">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label text-dark font-weight-bold" for="total_sks">Total SKS Lulus <span class="text-danger">*</span></label>
                                <input type="number" name="total_sks" id="total_sks" class="form-control" placeholder="Contoh: 110" value="{{ old('total_sks', 0) }}" min="0" data-required="true">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-dark font-weight-bold" for="gpa">IPK (GPA) <span class="text-danger">*</span></label>
                                <input type="number" name="gpa" id="gpa" class="form-control" placeholder="Contoh: 3.50" value="{{ old('gpa', '0.00') }}" min="0" max="4" step="0.01" data-required="true">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="section-dpl" class="role-section d-none border-top pt-4 mt-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="nip" id="nip" class="form-control" placeholder="Contoh: 19880101..." value="{{ old('nip') }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-dark font-weight-bold" for="nidn">NIDN</label>
                                <input type="text" name="nidn" id="nidn" class="form-control" placeholder="Contoh: 040101..." value="{{ old('nidn') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="position" id="position" class="form-control" placeholder="Contoh: Lektor, Asisten Ahli" value="{{ old('position') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-dark font-weight-bold" for="specialization">Bidang Keahlian</label>
                                <input type="text" name="specialization" id="specialization" class="form-control" placeholder="Contoh: AI, Rekayasa Perangkat Lunak" value="{{ old('specialization') }}">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="max_mentee" id="max_mentee" class="form-control" placeholder="Contoh: 10" value="{{ old('max_mentee', 5) }}" min="1" data-required="true">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="leader_study_program_id" id="leader_study_program_id" class="form-control" data-required="true">
                                    <option value="">Pilih Program Studi...</option>
                                    @foreach($studyPrograms as $sp)
                                        <option value="{{ $sp->id }}" {{ old('leader_study_program_id') == $sp->id ? 'selected' : '' }}>{{ $sp->degree }} - {{ $sp->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="leader_faculty_id" id="leader_faculty_id" class="form-control" data-required="true">
                                    ...
                                    @foreach($faculties as $fac)
                                        <option value="{{ $fac->id }}" {{ old('leader_faculty_id') == $fac->id ? 'selected' : '' }}>{{ $fac->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div id="section-supervisor" class="role-section d-none border-top pt-4 mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="position" id="supervisor_position" class="form-control" placeholder="Contoh: HR Manager, Tech Lead" value="{{ old('position') }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-dark font-weight-bold" for="division">Divisi / Departemen</label>
                                <input type="text" name="division" id="division" class="form-control" placeholder="Contoh: Engineering, Human Resources" value="{{ old('division') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex gap-3 justify-content-end border-top pt-4 mt-5">
                        ...
                        <button type="submit" class="btn btn-primary px-4 py-2" style="font-size: 13px;">Buat User</button>
                    </div>
                </form>
            </div>
        </div>
