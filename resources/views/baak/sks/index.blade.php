...
<div class="row">
    <div class="col-12">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <!-- Filter & Search -->
                <form action="{{ route('baak.sks.index') }}" method="GET" class="row g-2 mb-4 align-items-center">
                    <div class="col-md-5">
                    ...
                    <div class="col-md-2">
                        <select name="status" class="form-control form-select">
                            ...
                            <option value="pending" {{ request('status') === 'pending' ? 'selected' : '' }}>Belum Eligible</option>
                        </select>
                    </div>
                    <div class="col-md-2 d-flex gap-2">
                        ...
                        @if(request()->anyFilled(['search', 'study_program_id', 'status']))
                            <a href="{{ route('baak.sks.index') }}" class="btn btn-light" title="Reset">
