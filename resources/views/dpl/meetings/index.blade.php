...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dpl.dashboard') }}">Dashboard</a></li>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            @if($meeting->status !== 'completed' && $meeting->status !== 'cancelled')
                                                ...
                                                <a href="{{ route('dpl.meetings.edit', $meeting->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                            @endif
                                            <form action="{{ route('dpl.meetings.destroy', $meeting->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus jadwal ini?')">
                                                @csrf
                                                @method('DELETE')
