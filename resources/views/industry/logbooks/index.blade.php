...
@section('title', 'Logbook Mahasiswa Magang')

@section('content')
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            <h4>Review Jurnal Logbook Harian</h4>
            <p class="mb-0">Daftar logbook harian mahasiswa magang aktif di perusahaan Anda.</p>
        </div>
    </div>
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Industri</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Logbook</a></li>
        </ol>
    </div>
</div>
    ...
    <div class="col-12">
        ...
        <div class="card-body bg-white mb-3 p-0 shadow-sm border rounded">
            ...
            <div class="card-body py-3">
                <form action="{{ route('industry.logbooks.index') }}" method="GET" class="row align-items-end">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 mb-3 d-flex">
                        ...
                        @if(request('search') || request('month') || request('history_tab') || request('status'))
                            <a href="{{ route('industry.logbooks.index') }}" class="btn btn-light btn-sm px-3">Reset</a>
                        @endif
                    </div>
                </form>
            </div>
                        ...
                        <tbody>
                            @forelse($logbooks as $log)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('industry.logbooks.show', $log->id) }}" class="btn btn-primary btn-sm px-3 shadow-xs">
