...
<div class="row page-titles mx-0">
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('industry.logbooks.index') }}">Logbook</a></li>
...
<div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        @php
            $myReview = $logbook->reviews->where('reviewer_type', 'industry')->first();
        @endphp
        <div class="card mb-4 sticky-top" style="top: 95px; z-index: 10;">
            ...
            <div class="card-body">
                <h5 class="text-dark mb-4" style="font-weight: 700; line-height: 1.4;">
                    @if($myReview)
                        <i class="la la-edit text-warning me-1 mr-1"></i> Perbarui Umpan Balik
                    @else
                        <i class="la la-check-circle text-primary me-1 mr-1"></i> Beri Umpan Balik
                    @endif
                </h5>

                <form action="{{ route('industry.logbooks.review', $logbook->id) }}" method="POST">
                    @csrf
                    ...
                    @else
                        <button type="submit" class="btn btn-primary btn-block btn-lg shadow-xs" style="font-weight: 600; font-size: 14px; border-radius: 6px;">
                            <i class="la la-save me-1 mr-1"></i> Simpan Catatan Review
                        </button>
                    @endif
                </form>
            </div>
