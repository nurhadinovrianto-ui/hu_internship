...
@section('title', 'Lacak Mahasiswa Realtime - ' . $context['title'])
...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <div class="welcome-text">
            ...
            <p class="mb-0">Pemantauan lokasi GPS dan kepatuhan area magang mahasiswa (Portal {{ $context['title'] }})</p>
        </div>
    </div>
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ $context['homeRoute'] }}">{{ $context['title'] }}</a></li>
            <li class="breadcrumb-item active"><a href="javascript:void(0)">Lacak Mahasiswa</a></li>
        </ol>
    </div>
</div>

<!-- EDUMIN SIGNATURE STAT CARDS (Identik dengan Dashboard Utama) -->
<div class="row">
            ...
            <div class="card-body p-4">
                <div class="media align-items-center">
                    ...
                    <div class="media-body text-white text-end">
                        ...
                        <small class="text-white opacity-75" style="font-size: 11px;">Mahasiswa Terbimbing</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-8 col-lg-7 col-md-12 mb-4">
        <div class="card shadow-sm border-0">
            <div class="card-header border-0 pb-0 d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    <h4 class="card-title">Peta Persebaran Mahasiswa</h4>
        ...
        <div class="card shadow-sm border-0 h-100">
            ...
            <div class="card-body pt-3">
                ...
                <div class="row g-2 mb-3">
                    <div class="{{ $studyPrograms->count() <= 1 ? 'd-none' : 'col-6' }}">
                    ...
                    <div class="{{ $industries->count() <= 1 ? 'd-none' : ($studyPrograms->count() <= 1 ? 'col-12' : 'col-6') }}">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Endpoints dinamis sesuai role
    const liveDataUrl = "{{ route($context['prefix'] . '.tracking.live-data') }}";
    const historyUrlPrefix = "{{ url($context['prefix'] . '/tracking') }}";
    ...
    function fetchLiveData() {
        ...
        fetch(`${liveDataUrl}?${params.toString()}`, {
            headers: {
    ...
    function loadStudentRoute(studentId, studentName) {
        ...
        fetch(`${historyUrlPrefix}/${studentId}/history`, {
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'Accept': 'application/json'
            }
