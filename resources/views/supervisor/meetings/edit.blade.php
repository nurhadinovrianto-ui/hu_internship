...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('supervisor.meetings.index') }}">Meetings</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ route('supervisor.meetings.update', $meeting->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <a href="{{ route('supervisor.meetings.index') }}" class="btn btn-light mt-3">Batal</a>
                        </form>
                    </div>
                </div>
            </div>
